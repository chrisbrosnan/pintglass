                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="bio" class="form-control @error('bio') is-invalid @enderror" name="bio" value="{{ old('bio') }}" required autocomplete="bio" autofocus></textarea>
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="favbev" type="text" class="form-control @error('favbev') is-invalid @enderror" name="favbev" value="{{ old('favbev') }}" required autocomplete="favbev" autofocus>
						...
						<div class="form-group row">
                            <label for="bio" class="col-md-4 col-form-label text-md-right">{{ __('Favourite Pub/Bar') }}</label>

                            <div class="col-md-6">
                                <input id="favbar" type="text" class="form-control @error('favbar') is-invalid @enderror" name="favbar" value="{{ old('favbar') }}" required autocomplete="favbar" autofocus>
